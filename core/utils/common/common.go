...
// other binary secrets prefer this over RandStr, which is restricted to the
// 62-char alphanumeric alphabet (~5.95 bits/char) and so yields ~95 bits of
// entropy for a 16-char output instead of a full 128.
